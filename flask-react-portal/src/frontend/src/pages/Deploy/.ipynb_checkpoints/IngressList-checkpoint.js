...
import IngressInfoList from 'components/Deploy/IngressInfoList';
import { connect } from 'react-redux';
import { Redirect } from 'react-router'

class IngressList extends Component {
  ...
  render() {
    ...
    const {ingresses} = this.state;

    if(this.props.sessionYn === "TRUE"){
        
    return (
      <div>
          <IngressInfoList ingresses={ingresses}
...
export default connect(mapStateToProps)(IngressList);